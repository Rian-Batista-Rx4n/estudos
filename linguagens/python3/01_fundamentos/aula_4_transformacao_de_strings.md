...
- Como fazer **Fatiamento** para separar partes do texto
- Como fazer **Contagem de caracteres**
- Como **Procurar caracteres**
- Fazer uma analise e **Verificar existencia** de algo
- Fazer o **Reposicionamento** de texto
- Fazer alteração de **Maiusculas e Minusculas**
- Como **Capitalizar**
- Como **Titular palavras**
- Como **Remover espaços**
- Como separar texto e **Dividir em palavras**
...
a manipulação de strings é usado **`[ ]`** elas são determinadas em 3 caracteristicas **[Inicio : Fim : Pulos ]**.
...
> `frase = 'Rian Batista'`
> 
> Em teoria, o sistema imterpreta assim:
> ```text
...
Quando usamos `frase[0:12:3]` digamos ao python para **selecionar da posição 0 a 12, dando pulos de 3 caracteres...**, 

> [!NOTE]
> vamos entender melhor:
> *R-i-a-n- -B-a-t-i-s-t-a* se pularmos de 3, significa *1-R, ok, 2-i, ok, 3-a, não!, 1-n, ok, 2- , ok, 3-B, não!...* 
> e continua até acabar, ele faz esse contagem, quando der o valor do pulo, ele ignora aquela caracter
